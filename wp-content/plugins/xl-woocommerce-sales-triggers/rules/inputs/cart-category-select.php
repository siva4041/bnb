...
class WCST_Input_Cart_Category_Select {
	...
	public function render( $field, $value = null ) {
        ...
        <table style="width:100%;">
            <tr>
                <td style="width:32px;"><?php _e( 'Quantity', WCST_SLUG ); ?></td>
                <td><?php _e( 'Categories', WCST_SLUG ); ?></td>
            </tr>
            <tr>
                ...
                <td>
                    <select id="<?php echo $field['id']; ?>" name="<?php echo $field['name']; ?>[categories][]" class="chosen_select <?php echo esc_attr( $field['class'] ); ?>" multiple="multiple" data-placeholder="<?php echo( isset( $field['placeholder'] ) ? $field['placeholder'] : __( 'Search...', WCST_SLUG ) ); ?>">
						<?php
