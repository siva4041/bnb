...
add_action( 'wp', 'wcst_theme_helper_tucson', 98 );
if ( ! function_exists( 'wcst_theme_helper_tucson' ) ) {

	function wcst_theme_helper_tucson() {
...
add_action( 'woocommerce_before_template_part', 'wcst_theme_helper_tucson_before_template_part', 98 );
if ( ! function_exists( 'wcst_theme_helper_tucson_before_template_part' ) ) {
	function wcst_theme_helper_tucson_before_template_part( $template_name = '', $template_path = '', $located = '', $args = array() ) {
...
add_action( 'woocommerce_after_template_part', 'wcst_theme_helper_tucson_after_template_part', 98 );
if ( ! function_exists( 'wcst_theme_helper_tucson_after_template_part' ) ) {
	function wcst_theme_helper_tucson_after_template_part( $template_name = '', $template_path = '', $located = '', $args = array() ) {
 ...
 */
add_action( 'woocommerce_after_add_to_cart_form', 'wcst_theme_helper_tucson_after_add_to_cart_template', 98 );
if ( ! function_exists( 'wcst_theme_helper_tucson_after_add_to_cart_template' ) ) {
	function wcst_theme_helper_tucson_after_add_to_cart_template() {
