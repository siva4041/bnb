 ...
 */
add_action( 'wp', 'wcst_theme_helper_astra', 98 );
if ( ! function_exists( 'wcst_theme_helper_astra' ) ) {
	function wcst_theme_helper_astra() {
...
add_action( 'woocommerce_before_template_part', 'wcst_theme_helper_astra_before_template_part', 98 );
if ( ! function_exists( 'wcst_theme_helper_astra_before_template_part' ) ) {
	function wcst_theme_helper_astra_before_template_part( $template_name = '', $template_path = '', $located = '', $args = array() ) {
		$wcst_core = WCST_Core::get_instance();
...
add_action( 'woocommerce_after_template_part', 'wcst_theme_helper_astra_after_template_part', 98 );
if ( ! function_exists( 'wcst_theme_helper_astra_after_template_part' ) ) {
	function wcst_theme_helper_astra_after_template_part( $template_name = '', $template_path = '', $located = '', $args = array() ) {
		$wcst_core = WCST_Core::get_instance();
		if ( empty( $template_name ) ) {
			return '';
		}
 ...
 */
add_action( 'woocommerce_after_add_to_cart_form', 'wcst_theme_helper_astra_after_add_to_cart', 98 );
if ( ! function_exists( 'wcst_theme_helper_astra_after_add_to_cart' ) ) {
	function wcst_theme_helper_astra_after_add_to_cart() {
		$wcst_core = WCST_Core::get_instance();
		$output    = "";
		ob_start();
