...
add_action( 'wp', 'wcst_theme_helper_oceanwp', 99 );
if ( ! function_exists( 'wcst_theme_helper_oceanwp' ) ) {

	function wcst_theme_helper_oceanwp() {
...
add_action( 'woocommerce_before_template_part', 'wcst_theme_helper_oceanwp_before_template_part', 99 );

if ( ! function_exists( 'wcst_theme_helper_oceanwp_before_template_part' ) ) {
	function wcst_theme_helper_oceanwp_before_template_part( $template_name = '', $template_path = '', $located = '', $args = array() ) {
		$wcst_core = WCST_Core::get_instance();
...
add_action( 'woocommerce_after_template_part', 'wcst_theme_helper_oceanwp_after_template_part', 99 );

if ( ! function_exists( 'wcst_theme_helper_oceanwp_after_template_part' ) ) {
	function wcst_theme_helper_oceanwp_after_template_part( $template_name = '', $template_path = '', $located = '', $args = array() ) {
 ...
 */
add_action( 'woocommerce_after_add_to_cart_form', 'wcst_theme_helper_oceanwp_after_add_to_cart_template' );
if ( ! function_exists( 'wcst_theme_helper_oceanwp_after_add_to_cart_template' ) ) {
	function wcst_theme_helper_oceanwp_after_add_to_cart_template() {
