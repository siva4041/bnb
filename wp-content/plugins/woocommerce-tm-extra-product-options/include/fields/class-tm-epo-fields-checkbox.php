...
class TM_EPO_FIELDS_checkbox extends TM_EPO_FIELDS {
	...
	public function display_field( $element = array(), $args = array() ) {
		...
		if ( $search_for_color == 'transparent' || preg_match( '/#([a-f]|[A-F]|[0-9]){3}(([a-f]|[A-F]|[0-9]){3})?\b/', $search_for_color ) ) {
			...
			$hexclass = $tmhexcolor;
			$this->css_string = "label ." . $tmhexcolor . " + .tmhexcolorimage, label ." . $tmhexcolor . " + span + .tc-label .tmhexcolorimage{background-color:" . $search_for_color . " !important;}";
			...
			if ( !empty( $element['item_width'] ) ) {
				...
				$this->css_string .= "label ." . $tmhexcolor . " + .tmhexcolorimage{display: inline-block !important;width:" . $element['item_width'] . " !important;min-width:" . $element['item_width'] . " !important;max-width:" . $element['item_width'] . " !important;}";
			}
			if ( !empty( $element['item_height'] ) ) {
				...
				$this->css_string .= "label ." . $tmhexcolor . " + .tmhexcolorimage{display: inline-block !important;height:" . $element['item_height'] . " !important;min-height:" . $element['item_height'] . " !important;max-height:" . $element['item_height'] . " !important;}";
			}
