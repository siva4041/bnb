...
if ( !function_exists( 'tc_get_product_att' ) ) {

	/**
	 * @param $product
	 * @return mixed
	 */
	function tc_get_product_att( $product, $att="" ) {
...
if ( !function_exists( 'tc_order_get_price_excluding_tax' ) ) {
	...
	function tc_get_product_from_item( $item, $order = false ) {
...
if ( !function_exists( 'tc_order_get_price_excluding_tax' ) ) {
	...
	function tc_order_get_price_excluding_tax( $order, $item_id, $args = array() ) {
		...
		$product = tc_get_product_from_item( $order_items[ $item_id ], $order );
