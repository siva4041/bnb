		...
		<tbody>
			<?php
				...
				foreach ( $grouped_products as $grouped_product_child ) {
					...
					echo '<tr id="product-' . esc_attr( $grouped_product_child->get_id() ) . '" class="woocommerce-grouped-product-list-item ' . esc_attr( implode( ' ', wc_get_product_class() ) ) . '">';
					...
					foreach ( $grouped_product_columns as $column_id ) {
						...
						switch ( $column_id ) {
							...
							case 'quantity':
								...
								break;
							case 'price':
                                $value = '<td class="price" data-title="' . esc_attr__( 'Price', 'woodmart' ) . '">';
    							$value .= '<div>';
