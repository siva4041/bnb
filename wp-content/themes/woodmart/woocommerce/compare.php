...
<head>
    ...
    <<?php echo $title_tag; ?>><?php _e( 'Product Comparison', 'yith-woocommerce-compare' ) ?></<?php echo $title_tag; ?>>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($){
        ...
        $(document).on('click', 'a.add_to_cart_button', function(){
            button_clicked = $(this);
            button_clicked.block({message: null, overlayCSS: {background: '#fff url(' + woocommerce_params.ajax_loader_url + ') no-repeat center', backgroundSize: '16px 16px', pacity: 0.6}});
        });
