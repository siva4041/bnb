	...
	function woodmart_shortcode_extra_menu($atts = array(), $content = null) {
		...
		ob_start(); ?>
			...
			<ul class="sub-menu<?php echo esc_attr( $class ); ?>" >
				<li class="<?php echo esc_attr( $liclass ); ?>"><a <?php echo ( $attributes ); ?>><span class="nav-link-text"><?php echo esc_html( $title ); ?></span><?php echo ($label_out); ?></a>
...
if( ! function_exists( 'woodmart_shortcode_extra_menu_list' ) ) {
	function woodmart_shortcode_extra_menu_list($atts, $content) {
		...
		ob_start(); ?>
			...
			<li class="<?php echo esc_attr( $class ); ?>"><a <?php echo ( $attributes ); ?>><span class="nav-link-text"><?php echo ( $title ); ?></span><?php echo ( $label_out ); ?></a></li>
