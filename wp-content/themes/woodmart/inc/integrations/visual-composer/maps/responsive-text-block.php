...
if( ! function_exists( 'woodmart_vc_map_responsive_text_block' ) ) {
	function woodmart_vc_map_responsive_text_block() {
		...
		$secondary_font_title = $secondary_font ? esc_html__( 'Secondary', 'woodmart' ) . ' (' . $secondary_font['font-family'] . ')' : esc_html__( 'Secondary', 'woodmart' );
		$primary_font_title = $primary_font ? esc_html__( 'Primary', 'woodmart' ) . ' (' . $primary_font['font-family'] . ')' : esc_html__( 'Primary', 'woodmart' );
		$text_font_title = $text_font ? esc_html__( 'Text', 'woodmart' ) . ' (' . $text_font['font-family'] . ')' : esc_html__( 'Text', 'woodmart' );
