		...
		vc_map( array(
			...
			'params' => array(
				...
				array(
					...
					'param_name' => 'date',
					'hint' => esc_html__( 'Final date in the format Y/m/d. For example 2020/12/12', 'woodmart' ),
				),
				/**
				* Style
				*/
				...
				array(
					...
					'style' => array(
						'active' => woodmart_get_opt( 'primary-color' ) ? woodmart_get_opt( 'primary-color' ) : '#7eb934',
					),
