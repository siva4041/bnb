...
if ( ! function_exists( 'woodmart_vc_map_title' ) ) {
	function woodmart_vc_map_title() {
		...
		$alt_font_subtitle = $secondary_font ? esc_html__( 'Alternative', 'woodmart' ) . ' (' . $secondary_font['font-family'] . ')' : esc_html__( 'Alternative', 'woodmart' );
		$default_font_subtitle = $default_font ? esc_html__( 'Default', 'woodmart' ) . ' (' . $default_font['font-family'] . ')' : esc_html__( 'Default', 'woodmart' );
			...
			'params' => array(
				...
				*/
				...
				array(
					...
					'heading' => esc_html__( 'Predefined title color scheme', 'woodmart' ),
					'param_name' => 'color',
